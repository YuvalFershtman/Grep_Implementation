...
{
    command_arguments arguments = {false, 0, false, false, false, false, false, false, false, NULL, NULL, false};
    ...
    int count_line_number = 0, count_prints = 0, byts_count_file = 0;
    int num_of_prints_next = 0, num_of_prints_so_far = 0;
    bool print_pre = false;
    bool print_next = false;
    while (1) {
        size_t bytes_read;
        line_struct line = {NULL,  0,     count_line_number, byts_count_file, num_of_prints_next, num_of_prints_so_far,
                            false, false, print_next,        print_pre};
